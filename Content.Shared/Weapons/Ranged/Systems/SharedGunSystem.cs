...
public abstract partial class SharedGunSystem : EntitySystem
{
    ...
    private List<EntityUid>? AttemptShoot(EntityUid user, EntityUid gunUid, GunComponent gun, List<int>? predictedProjectiles = null, ICommonSession? userSession = null)
    {
        ...
        var isRechargingGun = HasComp<RechargeBasicEntityAmmoComponent>(gunUid); // Goobstation
    ...
    public virtual void ShootProjectile(EntityUid uid, Vector2 direction, Vector2 gunVelocity, EntityUid gunUid, EntityUid? user = null, float speed = 40f)
    {
