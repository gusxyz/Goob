...
{
    // Public fields
    public IProgressionNode Prototype;
    public Action<IProgressionNode, ResearchAvailability>? SelectAction;
    private readonly ResearchAvailability Availability;

    // Some visuals
    private static readonly Color DefaultColor = Color.FromHex("#141F2F");
    private static readonly Color DefaultBorderColor = Color.FromHex("#4972A1");
    private static readonly Color DefaultHoveredColor = Color.FromHex("#4972A1");

    private readonly Color _color = DefaultColor;
    private readonly Color _borderColor = DefaultBorderColor;
    private readonly Color _hoveredColor = DefaultHoveredColor;

    public FancyResearchConsoleItem(IProgressionNode proto, SpriteSystem sprite, ResearchAvailability availability)
    {
